...
export default function Footer() {
  return (
    <>
      <div>
        <hr></hr>
      <footer className="footer bg text-content p-3">
  <aside >
    <svg
      width="50"
      height="50"
    ...
    <p>
      All rights reserved
      <br />
      Supportive Partner <span className='text-orange-600 font-semibold'> TechWith-Abhinav</span>
    </p>
  </aside>
  <nav>
    <h6 className="footer-title p-1 ">Social</h6>
